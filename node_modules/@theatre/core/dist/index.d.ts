 ...
 */
declare type PathToProp_Encoded = Nominal<'PathToProp_Encoded'>;
 ...
 */
declare type StrictRecord<Key extends string, V> = {
    [K in Key]?: V;
};
...
declare type HistoricPositionalSequence = {
 ...
 */
declare type TrackData = BasicKeyframedTrack;
declare type KeyframeType = 'bezier' | 'hold';
...
declare type TrackDataCommon<TypeName extends string> = {
    type: TypeName;
    /**
...
declare type BasicKeyframedTrack = TrackDataCommon<'BasicKeyframedTrack'> & {
    /**
...
declare type PropTypeConfig_AllSimples = PropTypeConfig_Number | PropTypeConfig_Boolean | PropTypeConfig_String | PropTypeConfig_StringLiteral<$IntentionalAny> | PropTypeConfig_Rgba | PropTypeConfig_Image;
...
declare type KeyframeId = Nominal<'KeyframeId'>;
...
declare type SequenceTrackId = Nominal<'SequenceTrackId'>;
...
declare type SheetObjectAction = (object: ISheetObject) => void;
declare type SheetObjectActionsConfig = Record<string, SheetObjectAction>;
interface ISheet {
    /**
 ...
 *
 */
declare type __UNSTABLE_Project_OnDiskState = OnDiskState;
