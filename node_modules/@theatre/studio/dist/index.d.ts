...
declare type ToolconfigFlyoutMenuItem = {
    label: string;
    onClick?: () => void;
};
declare type ToolConfigFlyoutMenu = {
    /**
     * A flyout menu
     */
    type: 'Flyout';
...
declare type ToolConfig = ToolConfigIcon | ToolConfigSwitch | ToolConfigFlyoutMenu;
